class HistoriesController < ApplicationController
  ...
  def rollback
    ...
    version = @history.versions.find(params[:version])
    if version.reify.save
      redirect_to @history, notice: "USER WAS SUCCESSFULLY ROLLBACKED"
    else
      render :show
    end
  end
  ...
  def history_params
    params.require(:history).permit(:title, :author)
  end
end
